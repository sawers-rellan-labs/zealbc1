...
| `rtiger_ancestry_inference.sbatch` | union pilot, ancestry inference | RTIGER ancestry per line on the donor's own tier-A sites (BC2S3, rigidity 500, zero-ALT sites excluded) |
